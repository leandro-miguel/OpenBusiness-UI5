sap.ui.define([
	...
	return Controller.extend("requisitions.requisitions.controller.offer.ListOffer", {
		formatter: Formatter,

		onInit: function () {
			this.getView().setModel(new JSONModel(), "oModelListOffer");
		},

		onBeforeRendering: function () {
			var oModel = this.getModel("oModelListOffer");
		...
		onCompanySelect: function (oEvent) {
			var idEmp = oEvent.getParameter("selectedItem").getProperty("key"),
				oModel = this.getModel("oModelListOffer"),
		...
		deleteToken: function (oEvent) {
			var sPath = oEvent.getSource().getBindingContext("oModelListOffer").sPath;
